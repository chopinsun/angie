 ...
 **/
public class ReferenceAnnotationScanner extends ClassPathBeanDefinitionScanner {
    public ReferenceAnnotationScanner(BeanDefinitionRegistry registry) {
        super(registry);
    }
    public void registerDefaultFilters() {
        this.addIncludeFilter(new AnnotationTypeFilter(AngieReference.class));
    }
    ...
    public boolean isCandidateComponent(AnnotatedBeanDefinition beanDefinition) {
        return super.isCandidateComponent(beanDefinition) && beanDefinition.getMetadata()
                .hasAnnotation(AngieReference.class.getName());
    }
